...
class ClassificationWithBSDD:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ClassificationWithBSDD_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&ClassificationWithBSDD')
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/classification_with_bsdd/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Classify features with bSDD concepts'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&ClassificationWithBSDD'),
                action)
